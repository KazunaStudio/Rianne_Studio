                    ...
                    <Offcanvas.Body className="Offcanvas">
                      <Nav className="itemNav sticky-top" variant="underline">
                        <div className="textLinks">
                          <Link to="/About" onClick={handleLinkClick} className={`hovering2 ${location.pathname === '/About' ? 'highlight2' : 'textnav'}`}>About</Link>
                          <Link to="/Portfolio"onClick={handleLinkClick} className={`hovering2 ${location.pathname === '/Portfolio' ? 'highlight2' : 'textnav'}`}>Portfolio</Link>
                          <Link to="/Contact" onClick={handleLinkClick} className={`hovering2 ${location.pathname === '/Contact' ? 'highlight2' : 'textnav'}`}>Contact</Link>
                        </div>
                        <div className="iconLinks">
                          <Link to="mailto:RianneOng@gmail.com"  onClick={handleLinkClick} target="_blank" className='iconsNav'>
                          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" class="bi bi-envelope-at-fill" viewBox="0 0 16 16">
                          ...
                          {/* <Link to="https://wa.me/6585355703" target="_blank" className='iconsNav'>
                          ...
                          {/* <Link to='' className='hovering3' style={{fontSize:"14px",color:"black",textAlign:"left",fontFamily:"Ralewaylight"}}>
                          ...
                          <Link to="https://t.me/KazuKitsune" target="_blank" onClick={handleLinkClick} className='iconsNav'>
                          ...
                          <Link to="https://www.linkedin.com/in/rianne-ong/" onClick={handleLinkClick} target="_blank" className='iconsNav'>
                              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" class="bi bi-linkedin" viewBox="0 0 16 16" style={{borderRadius:"50%"}}>
