                ...
                <Container fluid >
                  <table className='tables2'>
                    <td className='column1'>
                      <tr>
                        <Navbar.Brand href="../" className='image-container'>
                  ...
                  <Navbar.Offcanvas>
                    <Offcanvas.Header closeButton style={{backgroundColor:"#406a74"}}>
                      <Offcanvas.Title style={{fontSize:"24px"}}>
                        <a href="../Home"><img src={logo} className='image2' alt="Logo"/></a> <b style={{paddingLeft:"10%",fontSize:"30px", color:"white"}}>Welcome!</b>
                      </Offcanvas.Title>
                    </Offcanvas.Header>
                    <Offcanvas.Body className="Offcanvas">
                      <Nav className="itemNav sticky-top" variant="underline">
                        <Nav.Link href="./About" className={`hovering2 ${location.pathname === '/About' ? 'highlight2' : ''}`} style={{fontSize:"20px",color:"white"}}>About</Nav.Link>
                        <Nav.Link href="./Portfolio" className={`hovering2 ${location.pathname === '/Portfolio' ? 'highlight2' : ''}`} style={{fontSize:"20px",color:"white"}}>Portfolio</Nav.Link>
