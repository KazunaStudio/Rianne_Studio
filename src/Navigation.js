                    ...
                    <Offcanvas.Body className="Offcanvas">
                      <Nav className="itemNav sticky-top" variant="underline">
                        <div className="textLinks">
                          <Link to="/About" className={`hovering2 ${location.pathname === '/About' ? 'highlight2' : 'textnav'}`}>About</Link>
                          <Link to="/Portfolio" className={`hovering2 ${location.pathname === '/Portfolio' ? 'highlight2' : 'textnav'}`}>Portfolio</Link>
                          <Link to="/Contact" className={`hovering2 ${location.pathname === '/Contact' ? 'highlight2' : 'textnav'}`}>Contact</Link>
                        </div>
                        <div className="iconLinks">
                          <Link to="mailto:RianneOng@gmail.com" target="_blank" className='iconsNav'>
                          ...
                          <Link to="https://t.me/KazuKitsune" target="_blank" className='iconsNav'>
                          ...
                          <Link to="https://www.linkedin.com/in/rianne-ong/" target="_blank" className='iconsNav'>
